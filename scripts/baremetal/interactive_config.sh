...
write_configuration() {        
    ...
    update_env_var "GPU_AVAILABLE_NVIDIA" "$GPU_AVAILABLE_NVIDIA" "$DATA_DIR/.env"
    update_env_var "GPU_AVAILABLE_INTEL" "$GPU_AVAILABLE_INTEL" "$DATA_DIR/.env"
    update_env_var "GPU_AVAILABLE_AMD" "$GPU_AVAILABLE_AMD" "$DATA_DIR/.env"
