...
from db.models.customfilter import CustomFilterRead, FilterType
from db.models.trailerprofile import TrailerProfileRead
from download.conversion import (
...
class TestVideoConversionHardwareAcceleration:
    ...
    @patch("download.conversion.app_settings")
    ...
    @patch("download.conversion._get_video_options_cpu")
    ...
    @patch("download.conversion.get_media_info")
    @patch("download.conversion.app_settings")
