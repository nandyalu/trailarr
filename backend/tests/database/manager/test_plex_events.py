...
from database.models.event import EventSource, EventType
from database.engine import write_session
import database.manager.media as media_manager
import database.manager.event as event_manager
from database.manager.event.helpers import (
    track_plex_linked,
    track_plex_unlinked,
...
class TestTrackPlexLinked:
    ...
    def test_does_not_raise_on_invalid_media_id(self):
        """Gracefully swallows exceptions when media_id is invalid."""
        track_plex_linked(
            media_id=99999,
