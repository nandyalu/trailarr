...
INSERT INTO alembic_version VALUES('b30b7b2fd9b4');
...
INSERT INTO pathmapping VALUES(1,2,'/nonexistent/fixture/tv','/nonexistent/fixture/tv',NULL);
INSERT INTO pathmapping VALUES(2,3,'/plex/tv','/nonexistent/fixture/tv','1');
...
INSERT INTO download VALUES('/nonexistent/fixture/m1-trailer.mkv','m1-trailer.mkv','h1',1000,1080,'mkv','vp9','opus',NULL,NULL,NULL,120,'ytid','chan',1,1,'2026-08-11 00:00:00','2026-08-11 00:00:00',1,1);
INSERT INTO download VALUES('/nonexistent/fixture/m2-trailer.mkv','m2-trailer.mkv','h2',1000,1080,'mkv','vp9','opus',NULL,NULL,NULL,120,'ytid','chan',1,1,'2026-08-11 00:00:00','2026-08-11 00:00:00',2,2);
INSERT INTO download VALUES('/nonexistent/fixture/tv/Fixture Show D (2024)/d-trailer.mkv','d-trailer.mkv','h3',1000,1080,'mkv','vp9','opus',NULL,NULL,NULL,120,'ytid','chan',1,2,'2026-08-11 00:00:00','2026-08-11 00:00:00',3,5);
...
INSERT INTO startuppass VALUES('attribute-downloads-v0.9.9','2026-08-11 00:00:00','v0.11.1');
INSERT INTO startuppass VALUES('full-scan-before-downloads-v0.10','2026-08-11 00:00:00','v0.11.1');
...
INSERT INTO downloadattempt VALUES(1,'default',2,'2026-08-10 00:00:00','Fixture: no trailer found',1,3);
...
INSERT INTO connection VALUES('Fixture Radarr','RADARR','http://localhost:7878','k',1,'2026-08-11 00:00:00','',NULL,1);
INSERT INTO connection VALUES('Fixture Sonarr','SONARR','http://localhost:8989','k',2,'2026-08-11 00:00:00','',NULL,1);
INSERT INTO connection VALUES('Fixture Plex','PLEX','http://localhost:32400','k',3,'2026-08-11 00:00:00','','fixture-machine',1);
...
INSERT INTO media VALUES(1,1,1,'Fixture Movie A',2024,'en',NULL,100,NULL,'/nonexistent/fixture/Fixture Movie A',NULL,'fx-1',NULL,NULL,NULL,NULL,0,1,1,'2026-08-11 00:00:00','2026-08-11 00:00:00',NULL,'fixture movie a','',0,'','fx-1',0,NULL,NULL,NULL,NULL,1,NULL);
INSERT INTO media VALUES(1,2,1,'Fixture Movie B',2024,'en',NULL,100,NULL,'/nonexistent/fixture/Fixture Movie B',NULL,'fx-2',NULL,NULL,NULL,NULL,1,1,2,'2026-08-11 00:00:00','2026-08-11 00:00:00',NULL,'fixture movie b','',0,'','fx-2',0,NULL,NULL,NULL,NULL,2,NULL);
INSERT INTO media VALUES(1,3,1,'Fixture Movie C',2024,'en',NULL,100,NULL,'/nonexistent/fixture/Fixture Movie C',NULL,'fx-3',NULL,NULL,NULL,NULL,1,1,3,'2026-08-11 00:00:00','2026-08-11 00:00:00',NULL,'fixture movie c','',0,'','fx-3',0,NULL,NULL,NULL,NULL,3,NULL);
INSERT INTO media VALUES(2,10,0,'Fixture Show D',2024,'en',NULL,45,NULL,'/nonexistent/fixture/tv/Fixture Show D (2024)',NULL,'fx-4',NULL,NULL,NULL,NULL,1,1,4,'2026-08-11 00:00:00','2026-08-11 00:00:00',NULL,'fixture show d','',0,'','fx-4',2,'1001','1',3,NULL,NULL,4);
INSERT INTO media VALUES(3,0,0,'Fixture Stray Show',2015,'en',NULL,45,NULL,'/nonexistent/fixture/tv',NULL,'fx-5',NULL,NULL,NULL,NULL,0,0,5,'2026-08-11 00:00:00','2026-08-11 00:00:00',NULL,'fixture stray show','',0,'','fx-5',0,'1002','1',3,NULL,NULL,5);
CREATE TABLE IF NOT EXISTS "trailerprofile" (
	...
	uploader_ids VARCHAR DEFAULT ('') NOT NULL, subtitles_auto_generated BOOLEAN DEFAULT '0' NOT NULL, 
...
INSERT INTO trailerprofile VALUES(1,'mkv','{title} ({year})-trailer.{ext}',0,'Trailers','opus',100,1080,'vp9',0,'srt','en',1,'','',30,600,0,'{title} {year} {is_movie} trailer',1,1,0,0,'','{media_folder}',0,2,0,1080,'',0);
INSERT INTO trailerprofile VALUES(1,'mkv','{title} ({year})-trailer.{ext}',1,'Trailers','opus',100,1080,'vp9',0,'srt','en',1,'','',30,600,0,'{title} {year} {is_movie} trailer',2,2,0,0,'','{media_folder}',0,2,0,1080,'',0);
