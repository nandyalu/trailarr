import pytest
from integrations.plex.sync import _resolve_show_root
...
class TestResolveShowRoot:
    ...
    def test_already_at_root_with_tvdb_id(self):
        result = _resolve_show_root("/tv/The Boys (2019) {tvdb-355567}", "The Boys")
    ...
    def test_short_title_heavy_decoration(self):
        result = _resolve_show_root("/tv/Lost (2004) {tvdb-73739}", "Lost")
        assert result == "/tv/Lost (2004) {tvdb-73739}"

    def test_title_with_country_disambiguator(self):
        result = _resolve_show_root("/tv/The Office (US) (2005)", "The Office")
