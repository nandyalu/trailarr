...
Revision ID: e18c27163b6e
Revises: 
Create Date: 2024-05-14 19:33:12.722835
...
def upgrade() -> None:
    ...
    sa.Column('arr_type', sa.Enum('RADARR', 'SONARR', name='arrtype'), nullable=False),
    sa.Column('url', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('api_key', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('monitor', sa.Enum('MONITOR_MISSING', 'MONITOR_NEW', 'MONITOR_SYNC', name='monitortype'), nullable=False),
