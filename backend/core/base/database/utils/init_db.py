...
SQLModel.metadata.naming_convention = CONVENTIONS

# !!! IMPORTANT !!!
# Import all the models that are used in the application so that \
# SQLModel can create the tables
from core.base.database.models.connection import Connection  # noqa: F401, E402
from core.base.database.models.media import Media  # noqa: F401, E402
from core.base.database.models.filter import Filter  # noqa: F401, E402
from core.base.database.models.customfilter import (  # noqa: F401, E402
    CustomFilter,
)  # noqa: F401, E402
from core.base.database.models.trailerprofile import (  # noqa: F401, E402
    TrailerProfile,
)  # noqa: F401, E402
