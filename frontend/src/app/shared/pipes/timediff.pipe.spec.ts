...
describe('TimediffPipe', () => {
    ...
    describe('TimediffPipe', () => {
        ...
        describe('transform', () => {
            it('should return observable with invalidReturn for null value', async () => {
            ...
            it('should return observable with invalidReturn for undefined value', async () => {
            ...
            it('should return observable with custom invalidReturn for null value', async () => {
            ...
            it('should return observable with time difference for valid date', async () => {
