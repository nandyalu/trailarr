...
- **External URL**: (Optional) If you access your Radarr/Sonarr instance through a reverse proxy or a different URL than the server URL, specify that here. For example, `https://arr.mydomain.com/radarr`. This URL will be used by Trailarr when generating links to media items in the web interface.
