...
!!! tip "Multiple Profiles - Multiple Downloads"
    ...
    {{ version_badge("upd", "0.10.2") }} The old `Stop Monitoring` option has been removed — multiple profiles are the supported way to get multiple videos. See [Stop Monitoring](settings/general.md#stop-monitoring).
