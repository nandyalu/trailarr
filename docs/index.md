...
- Follows [plex](https://www.plex.tv/){:target="_blank"} naming conventions. Works with Plex, Emby, Jellyfin, etc.
...
See the [Setup](./setup/setup.md) guide for detailed instructions on how to setup Trailarr.
