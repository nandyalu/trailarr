...
- Updated [Common Issues](https://nandyalu.github.io/trailarr/help/common/){:target="_blank"} with `File Access Slowness and Workaround` for Windows users, and `Cookies file not working`. 🐢
- Updated various other sections in the [Docs](https://nandyalu.github.io/trailarr/){:target="_blank"} to reflect the changes in the app.