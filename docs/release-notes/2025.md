...
- Modularized container entrypoint scripts for better maintainability and organization into separate functional components. 🛠️
...
- Added detailed documentation for modular entrypoint script architecture and development guidelines. 📝

**Other Changes:** ⚡

- Refactored container entrypoint into modular components: banner display, timezone configuration, directory setup, GPU detection, user management, environment configuration, and application startup. 🏗️
