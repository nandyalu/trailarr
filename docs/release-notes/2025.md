...
- Fixed a bug in that raised an error after resetting Web UI password using `WEBUI_PASSWORD=''` Env variable. Fixes [#291](https://github.com/nandyalu/trailarr/issues/291){:target="_blank"}.
