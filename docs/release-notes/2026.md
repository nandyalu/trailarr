...
- **New Plex Events** — Three new event types are tracked for Plex-linked media: `Plex Linked`, `Plex Unlinked`, and `Plex Scan Triggered`. See the [Events](../user-guide/events/index.md) page for details.
