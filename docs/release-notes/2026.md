...
- **Modals show again in Safari** — a dialog stayed hidden while the page behind it dimmed, because the dialog became visible only through a `display` animation that Safari does not apply the same way ([#653](https://github.com/nandyalu/trailarr/issues/653)).
