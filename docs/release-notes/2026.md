...
- With `WEBUI_DISABLE_AUTH=true`, the UI now hides the logout button and pauses live updates after inactivity (with a **Resume** dialog) instead of bouncing through the login page for a new session.
